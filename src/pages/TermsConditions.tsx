        ...
        <section className="py-10 px-6 md:px-12 lg:px-24">
          <div className="max-w-4xl mx-auto">
            <div className="mb-10 text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-2">Terms & Conditions</h1>
            ...
            <Card className="border-0 shadow-md mb-6 overflow-hidden">
              <CardContent className="p-8 md:p-10">
                <div className="prose prose-lg max-w-none prose-headings:text-black prose-headings:font-bold prose-p:text-gray-700">
                  <h2 className="text-2xl md:text-3xl font-bold mt-0">1. Introduction</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">2. Services</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">3. Payments and Refunds</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">4. Intellectual Property Rights</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">5. User Content and Marketing Consent</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">6. Warranties and Liability</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">7. Confidentiality</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">8. Testimonials and Reviews</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">9. Service Access and Limitations</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">10. Program Rules and Code of Conduct</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">11. Variation</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">12. Assignment</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">13. Severability</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">14. Law and Jurisdiction</h2>
                  <p>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mt-8">15. Contact Information</h2>
                  <p>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>(a) to schedule a conversation: <a href="https://calendly.com/poquillo/30-min" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://calendly.com/poquillo/30-min</a></li>
                    <li>(b) through our website: https://poquillo.co</li>
                  </ul>

                  <h2 className="text-2xl md:text-3xl font-bold mt-8">16. Blog-Specific Terms</h2>
                  <p>
