    ...
    <footer className="py-12 px-6 md:px-12 lg:px-24 bg-gray-50 text-center md:text-left">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/services" className="text-gray-600 hover:text-pink-500 transition">Services</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/services" className="text-gray-600 hover:text-pink-500 transition">Quick Consultation</Link></li>
                <li><Link to="/services" className="text-gray-600 hover:text-pink-500 transition">Business Clarity Session</Link></li>
                <li><Link to="/services" className="text-gray-600 hover:text-pink-500 transition">Strategy Session</Link></li>
              </ul>
            </div>
            <div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-500 text-sm">
          ...
          <p>
            <Link to="/privacy-policy" className="text-gray-500 hover:text-pink-500 transition mr-4">Privacy Policy</Link>
            <Link to="/terms-conditions" className="text-gray-500 hover:text-pink-500 transition">Terms & Conditions</Link>
          </p>
        </div>
      </div>
    </footer>
