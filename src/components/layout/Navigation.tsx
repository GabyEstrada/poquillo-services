    ...
    <>
      ...
      <nav className="py-6 px-6 md:px-12 lg:px-24 flex justify-between items-center border-b border-gray-100">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <Link to="/services" className={`text-gray-900 hover:text-pink-500 transition ${currentPage === 'programs' ? 'font-bold border-b-2 border-pink-500' : ''}`}>Services</Link>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white py-4 px-6 shadow-lg absolute w-full z-10">
          <div className="flex flex-col space-y-4">
            ...
            <Link to="/services" className={`text-gray-900 hover:text-pink-500 transition ${currentPage === 'programs' ? 'font-bold' : ''}`}>Services</Link>
